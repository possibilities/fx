...
const expected_names = [_][]const u8{
    ...
    "core.app.app_lifecycle.test.explicit launch auto defeats ambient and workspace yolo without persistence",
    "core.app.app_bootstrap_runtime.test.app bootstrap forwards explicit permission mode to lifecycle authority",
    ...
    "core.cli.cli_surface.test.global launch permission mode accepts exact auto for fresh and exact resume",
    "core.cli.cli_surface.test.global launch permission mode rejects widening duplicates and non-launch commands",
    "core.cli.cli_surface.test.process-only auto permissions file matches exact AgentWorkplace MCP names",
    ...
    "core.control.launch_admission_final_launcher.test.external launch controls admit only one exact auto permission mode",
