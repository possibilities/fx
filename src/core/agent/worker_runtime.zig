...
pub const WorkerRuntime = struct {
    ...
    pub fn admitPromptObserved(
        ...
        return self.admitPromptObservedInternal(alloc, prompt, steer_if_active, false);
    }
    ...
    pub fn admitWorkControlPromptObserved(
        ...
        return self.admitPromptObservedInternal(alloc, prompt, steer_if_active, true);
    }
...
test "work control snapshot and update enforce semantic bounds" {
    ...
    const admitted = try runtime.admitPromptObserved(alloc, reviewed, false);
    try std.testing.expectError(
